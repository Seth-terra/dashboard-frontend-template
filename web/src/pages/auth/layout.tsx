...
export default function AuthLayout() {
  ...
  return (
    <div className="grid mx-auto h-screen max-h-[120rem] max-w-[180rem] overflow-hidden bg-neutral-800 lg:grid-cols-2">
      <div
      ...
      <div className="relative">
        <div className="absolute inset-0 overflow-auto">
          <main className="mx-auto min-h-screen flex flex-col justify-center px-4 py-6 container 2xl:max-w-2xl xl:max-w-xl lg:py-12">
            <div className="overflow-hidden rounded-card bg-neutral-700 shadow-lg">
              <Link to={ROUTES.home}>
